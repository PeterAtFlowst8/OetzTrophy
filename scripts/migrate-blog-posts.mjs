...
const newPost = {
  ...
  excerpt: {
    de: 'Die OETZ TROPHY hat eine neue Website und ein überarbeitetes Event-Format. Boater X Anmeldung ab 17. Juni.',
    en: 'The OETZ TROPHY has a new website and a revised event format. Boater X registration from 17 June.',
  },
  ...
  body: {
    de: [
      ...
      textBlock('Der Boater X ist offen für alle Paddler ab WW III. Anmeldung startet am 17. Juni 2026 — direkt hier auf der neuen Website.'),
    ...
    en: [
      ...
      textBlock('Boater X is open to all paddlers from class III. Registration opens 17 June 2026 — right here on the new website.'),
