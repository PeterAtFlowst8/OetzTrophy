...
const newPost = {
  ...
  excerpt: {
    de: 'Die OETZ TROPHY hat eine neue Website und ein überarbeitetes Event-Format. Rennwochenende-Anmeldung ab 17. Juni.',
    en: 'The OETZ TROPHY has a new website and a revised event format. Race weekend registration from 17 June.',
  },
  ...
  body: {
    de: [
      ...
      textBlock('Die OETZ TROPHY bekommt ein neues Format. Die Teilnahme erfolgt weiterhin über die Qualifikationsläufe — aber das Rennen wird anders als bisher. Mehr dazu in den kommenden Wochen.'),
      textBlock('Die gemeinsame Rennwochenende-Anmeldung startet am 17. Juni 2026 direkt hier auf der neuen Website. Sie deckt die Qualifikation, die OETZ TROPHY und den Boater X ab.'),
    ...
    en: [
      ...
      textBlock('The OETZ TROPHY is getting a new format. Entry is still via the qualifying heats — but the race itself will be different from before. More details in the coming weeks.'),
      textBlock('The shared race-weekend registration opens 17 June 2026 right here on the new website. It covers qualification, the OETZ TROPHY and Boater X.'),
